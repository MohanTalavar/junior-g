...
const WhatsappFloat: React.FC = () => (
  <a
    ...
    className="fixed z-50 bottom-16 right-2 group"
  >
    <div
    ...
    >
      ...
      />
      <span className="text-white font-semibold text-lg whitespace-nowrap opacity-0 group-hover:opacity-100 group-hover:ml-3 transition-all duration-300 ease-in-out">
        {WHATSAPP_NUMBER}
      </span>
    </div>
  </a>
